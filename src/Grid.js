...
var Grid = exports = Class(View, function (supr) {
    ...
    /**
     * Recursively appends all neighbors from a given bomb into a shared array
     * Function completes when it reaches a bomb with no new neighbors
     * @param {Bomb} bomb
     * @param {Array} neighbors
     * @param {Boolean=false} matchingOnly
     * @private
     */
    ...
    //Add new row at top and move subsequent rows down
    ...
    //Determine if this is an odd row number (determines bomb horizontal placement)
